...
"")
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 40, 231, 17))
        font = QtGui.QFont()
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(20, 70, 241, 41))
        self.textEdit_2.setStyleSheet("background-color: rgb(55, 65, 81);\n"
"color: #ffffff;")
        self.textEdit_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.textEdit_2.setTabChangesFocus(True)
        self.textEdit_2.setObjectName("textEdit_2")
        self.label_5 = QtWidgets.QLabel(self.page)
        self.label_5.setGeometry(QtCore.QRect(100, 150, 281, 17))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.comboBox.setGeometry(QtCore.QRect(120, 190, 241, 41))
        ...
        self.StartBtn.setGeometry(QtCore.QRect(70, 270, 201, 41))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(12)
...
"background-color: rgb(55, 65, 81);")
        ...
        self.label_4.setGeometry(QtCore.QRect(290, 40, 231, 17))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.textEdit_3.setGeometry(QtCore.QRect(290, 70, 241, 41))
        self.textEdit_3.setStyleSheet("background-color: rgb(55, 65, 81);\n"
"color: #ffffff;")
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(23, 29, 251, 531))
        self.plainTextEdit.setMinimumSize(QtCore.QSize(0, 300))
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.textEdit = QtWidgets.QTextEdit(self.AskAI)
        self.textEdit.setGeometry(QtCore.QRect(20, 589, 271, 51))
...
"border-radius: 25px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(250, 600, 31, 31))
        self.pushButton.setMaximumSize(QtCore.QSize(16777215, 16777213))
...
"background-color: black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Disk Location"))
        self.textEdit_2.setPlaceholderText(_translate("MainWindow", "Select disk location"))
        self.label_5.setText(_translate("MainWindow", "Filter the type of files to recover"))
        ...
        self.label_4.setText(_translate("MainWindow", "Recovery Path"))
        self.textEdit_3.setPlaceholderText(_translate("MainWindow", "Select disk location"))
